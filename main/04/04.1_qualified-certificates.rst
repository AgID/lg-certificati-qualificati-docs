...
3. Al fine di ottemperare a quanto prescritto negli allegati I (lettera
   *h*), III (lettera *h*) e IV (lettera *i*) del :ref:`regolamento eIDAS <eIDAS>`,
   è utilizzato l’\ :code:`accessMethod` ``id-ad-caIssuers``, con
   :code:`accessLocation` ``uniformResourceIdentifier``.

4. L’estensione :code:`authorityKeyIdentifier` (`ᴏɪᴅ 2.5.29.35 <http://oid-info.com/get/2.5.29.35>`__)
   contiene almeno il campo :code:`keyIdentifier`, *non* marcata critica.
